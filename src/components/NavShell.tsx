            ...
            {[0, 1, 2].map((i) => (
              <span
                ...
                style={{
                  ...
                  height: 2,
                  borderRadius: 1,
                  background: isConnected ? '#4ade80' : 'var(--text-color)',
                }}
              />
            ))}
          </button>
                ...
                <div className="flex items-center gap-2">
                  <span
                    style={{
                      ...
                      height: 8,
                      borderRadius: '50%',
                      background: isConnected ? '#4ade80' : '#f23f42',
                      boxShadow: isConnected ? '0 0 6px #4ade80' : '0 0 6px #f23f42',
                      flexShrink: 0,
                    }}
                  />
                ...
                {isConnected && (
                  <>
                    {(fingerprint || walletAddress) && (
                      <div
                        className="rounded-lg p-2 text-xs font-mono space-y-0.5"
                        style={{
                      ...
                      >
                        ...
                        {walletAddress && (
                          <div className="truncate">📍 {walletAddress.slice(0, 22)}…</div>
                        )}
                      </div>
                    )}
                    <button
                ...
                {!isConnected && pairingUri && (
                  <>
                    <p className="text-xs text-center" style={{ color: 'var(--text-muted)' }}>
                      Scan with{' '}
                      <strong style={{ color: '#00d9ff' }}>Sage mobile</strong> or paste URI in{' '}
                      <strong style={{ color: '#00d9ff' }}>Sage desktop</strong>
                    </p>
                    ...
                    <div className="flex gap-1.5">
                      <input
                        ...
                        className="flex-1 rounded px-2 py-1 text-xs font-mono truncate"
                        style={{
                          background: 'rgba(0,0,0,0.35)',
                      ...
                      <button
                        ...
                        style={{
                          background: copied ? '#10b981' : '#00d9ff',
                          color: '#000',
                          cursor: 'pointer',
                          whiteSpace: 'nowrap',
                        }}
